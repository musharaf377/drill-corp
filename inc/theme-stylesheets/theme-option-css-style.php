...
$body_font['family'] = (isset($body_font['font-family']) && !empty($body_font['font-family'])) ? $body_font['font-family'] : 'FFF Acid Grotesk';
...
$typography_css = $drilllcorp->generate_css_code([
    'font-family' => $body_font['family'] . ', sans-serif'
], 'html,body');

$typography_css .= $drilllcorp->generate_css_code([
    'font-size' => $drilllcorp->sanitize_px($body_font['size']),
...
$heading_font['family'] = (isset($heading_font['font-family']) && !empty($heading_font['font-family'])) ? $heading_font['font-family'] : 'Darker Grotesque';
$heading_font['weight'] = (isset($heading_font['font-weight']) && !empty($heading_font['font-weight'])) ? $heading_font['font-weight'] : '700';

$heading_font_css = $drilllcorp->generate_css_code([
...
$body_font_css = $drilllcorp->generate_css_code([
...
$root_color_css = $drilllcorp->generate_css_code([
...
$preloader_css = $drilllcorp->generate_css_code([
...
$breadcrumb_css = $drilllcorp->generate_css_code([
...
$footer_padding_top = !empty($footer_top_spacing) ? $drilllcorp->sanitize_px($footer_top_spacing) : '';
$footer_padding_bottom = !empty($footer_bottom_spacing) ? $drilllcorp->sanitize_px($footer_bottom_spacing) : '';


$footer_css = $drilllcorp->generate_css_code([
...
$copyright_padding_top = !empty($copyright_area_top_spacing) ? $drilllcorp->sanitize_px($copyright_area_top_spacing) : '';
$copyright_padding_bottom = !empty($copyright_area_bottom_spacing) ? $drilllcorp->sanitize_px($copyright_area_bottom_spacing) : '';

$copyright_css = $drilllcorp->generate_css_code([
...
$header_one_css = $drilllcorp->generate_css_code([
...
$sidebar_css = $drilllcorp->generate_css_code([
...
$err_padding_top = !empty($err_404_spacing_top) ? $drilllcorp->sanitize_px($err_404_spacing_top) : '';
$err_padding_bottom = !empty($err_404_spacing_bottom) ? $drilllcorp->sanitize_px($err_404_spacing_bottom) : '';

$error_css = $drilllcorp->generate_css_code([
...
$blog_padding_top = !empty($blog_page_spacing_top) ? $drilllcorp->sanitize_px($blog_page_spacing_top) : '';
$blog_padding_bottom = !empty($blog_page_spacing_bottom) ? $drilllcorp->sanitize_px($blog_page_spacing_bottom) : '';

$blog_css = $drilllcorp->generate_css_code([
...
$blog_single_padding_top = !empty($blog_single_page_spacing_top) ? $drilllcorp->sanitize_px($blog_single_page_spacing_top) : '';
$blog_single_padding_bottom = !empty($blog_single_page_spacing_bottom) ? $drilllcorp->sanitize_px($blog_single_page_spacing_bottom) : '';

$blog_single_css = $drilllcorp->generate_css_code([
...
$archive_single_padding_top = !empty($archive_page_spacing_top) ? $drilllcorp->sanitize_px($archive_page_spacing_top) : '';
$archive_single_padding_bottom = !empty($archive_page_spacing_bottom) ? $drilllcorp->sanitize_px($archive_page_spacing_bottom) : '';

$archive_page_css = $drilllcorp->generate_css_code([
...
$search_single_padding_top = !empty($search_page_spacing_top) ? $drilllcorp->sanitize_px($search_page_spacing_top) : '';
$search_single_padding_bottom = !empty($search_page_spacing_bottom) ? $drilllcorp->sanitize_px($search_page_spacing_bottom) : '';

$search_page_css = $drilllcorp->generate_css_code([
...
$search_single_padding_top = !empty($service_single_page_spacing_top) ? $drilllcorp->sanitize_px($service_single_page_spacing_top) : '';
$search_single_padding_bottom = !empty($service_single_page_spacing_bottom) ? $drilllcorp->sanitize_px($service_single_page_spacing_bottom) : '';

$service_single_page_css = $drilllcorp->generate_css_code([
