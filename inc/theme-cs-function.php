...
if (! function_exists('cs_get_option')) {
	...
	{
		$options = get_option('drillcorp_theme_options'); // Attention: Set your unique id of the framework
...
if (! function_exists('cs_get_customize_option') && class_exists('CSF')) {
	...
	{
		$options = get_option('drillcorp_customize_options'); // Attention: Set your unique id of the framework
		return (isset($options[$option])) ? $options[$option] : $default;
	}
}
